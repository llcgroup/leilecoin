...
public:
    ...
    {
        // Leilecoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Leilecoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Leilecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Leilecoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Leilecoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Leilecoin: block index flags
    enum  
    {
