...
const QString BITCOIN_IPC_PREFIX("Leilecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Leilecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Leilecoin: click-to-pay handler");
    else
...
{
    // clicking on Leilecoin: URLs creates FileOpen events on the Mac:
